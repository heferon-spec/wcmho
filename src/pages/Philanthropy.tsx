...
const impactStats = [
  ...
  { value: "15,000+", label: "Meals Distributed" },
  { value: "8,700+", label: "Worldwide Donors" },
];

const features = [
  { icon: Shield, title: "Become A Volunteer", desc: "Join our mission and help deliver aid to communities that need it most." },
  { icon: Home, title: "Shelter For Homeless", desc: "Providing safe spaces, blankets, and shelter for the homeless and displaced." },
  { icon: Utensils, title: "Food & Nutrition", desc: "Feeding programs providing nutritious meals to families and children in need." },
  { icon: Heart, title: "Disaster Relief", desc: "Rapid response humanitarian aid for communities affected by natural disasters." },
];
...
const Philanthropy = () => (
  <div>
      ...
      <div className="relative container mx-auto px-4 pt-20">
        <div className="max-w-3xl">
          <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            <Heart className="w-4 h-4" /> Philanthropy & Humanitarian Aid
          </motion.span>
      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mt-3 mb-5">Compassion-Driven Humanitarian Outreach</h2>
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-heading font-semibold text-foreground">Join the Helping Team</h4>
                  <p className="text-sm text-muted-foreground">There are many ways you can contribute to our humanitarian mission and charity work worldwide.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Your generosity funds life-changing humanitarian programs for those in need — food, shelter, and essential supplies.</p>
                </div>
              </div>
            </div>
    ...
    <section className="section-padding">
      <div className="container mx-auto">
        <SectionHeading label="Watch & Learn" title="Project Videos" description="See our humanitarian and charity work in action." />
