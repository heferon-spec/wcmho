...
const Philanthropy = () => (
  <div>
      ...
      <div className="relative container mx-auto px-4 pt-20">
        <div className="max-w-3xl">
          <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            <Heart className="w-4 h-4" /> Philanthropy & Outreach
          </motion.span>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="flex flex-wrap gap-4">
            <Button asChild size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90 text-base px-8">
              <Link to="/campaigns">View Campaigns <ArrowRight className="w-4 h-4 ml-2" /></Link>
            </Button>
      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mt-3 mb-5">Compassion-Driven Mental Health Advocacy</h2>
    ...
    <section className="section-padding bg-muted">
      <div className="container mx-auto">
        <SectionHeading label="Our Campaigns" title="Help & Donate Our Campaigns" description="Support our mental health initiatives and make a real difference." />
          ...
          {blogPosts.map((post, i) => (
            <motion.article key={post.title} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}
              ...
              <div className="aspect-video overflow-hidden relative">
                ...
                <div className="absolute top-3 left-3 bg-accent text-accent-foreground text-xs font-bold px-3 py-1 rounded-lg">{post.date}</div>
              </div>
              <div className="p-5">
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          ...
          <p className="text-lg text-primary-foreground/80 max-w-2xl mx-auto mb-8">Join our mission to make mental health care accessible to everyone.</p>
