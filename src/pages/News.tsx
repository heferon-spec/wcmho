...
const articles = [
  {
    ...
    excerpt: "World Mental Health Day highlights a national crisis: 1 in 3 South Africans will experience mental illness in their lifetime — yet 9 out of 10 go untreated.",
    readTime: "5 min",
    fullContent: "South Africa faces a growing mental health crisis. Approximately 1 in 3 South Africans will experience a mental health condition in their lifetime. Yet, shockingly, 9 out of 10 people who need treatment do not receive it due to stigma, lack of resources, and limited access to care.\n\nWorld Mental Health Day is a moment to break down these barriers through community engagement, educational workshops, and grassroots advocacy — reaching people through social media, community events, and partnerships with schools and workplaces.\n\nKey initiatives include free mental health screenings at community centres, training for educators to identify early signs of distress in learners, and the establishment of peer support groups in underserved communities. Advocacy continues for increased government funding for mental health services and the integration of mental health care into primary health care facilities.\n\nWorld Changers Mental Health Care Org is proud to contribute trained counsellors, resources, and community outreach programs to support the national effort.",
  },
  {
    title: "Soweto Marches Together for Mental Health Awareness",
    date: "04 Nov 2025", category: "Community", image: portfolioCom1,
    excerpt: "Mental Health Awareness Month closed with a powerful march at Chris Hani Baragwanath Hospital, calling on the community to stand together for change.",
    readTime: "4 min",
    fullContent: "In a powerful show of solidarity, hundreds of community members, healthcare workers, and mental health advocates gathered at Chris Hani Baragwanath Hospital in Soweto for a march marking the close of Mental Health Awareness Month.\n\nThe march, organised in partnership with local organisations including World Changers MHC Org, featured speakers who shared personal stories of recovery, healthcare professionals who highlighted the urgent need for accessible mental health services, and community leaders who pledged their commitment to destigmatising mental illness.\n\nParticipants carried banners with messages of hope and solidarity, chanting slogans that echoed through the streets of Soweto. The event also included free mental health screenings, information booths, and resource distribution for community members seeking support.\n\nThe march highlighted the disproportionate impact of mental health conditions on marginalised communities, where access to care is often limited by poverty, distance from health facilities, and cultural stigma. Organisers called for the government to allocate more resources to community-based mental health services.",
  },
  {
  ...
  {
    title: "Know Where to Turn: What to Do in a Mental Health Crisis",
    date: "01 May 2025", category: "Crisis Support", image: campaignBg,
    excerpt: "World Changers offers scheduled, appointment-based care — not a 24-hour line. Here's what to do if you or someone you know needs help right now.",
    readTime: "5 min",
    fullContent: "World Changers Mental Health Care Org provides scheduled, appointment-based counselling and psychosocial support. We are not a 24-hour emergency service — so knowing where to turn in a crisis matters.\n\nIf you or someone you know is in immediate danger or acute distress:\n\n• Call 112 (national emergency line, free from any cell phone) or 10177 (ambulance)\n• Go to your nearest hospital emergency department, or ask someone you trust to take you\n• Do not wait for an appointment — emergencies need emergency care\n\nOnce the immediate crisis has passed, ongoing support makes all the difference. That is where we come in: our qualified counsellors and social workers provide scheduled virtual sessions, psychosocial support, and a path to longer-term wellbeing.\n\nIf you are struggling but not in immediate danger, request an appointment through our Mental Health Services page — reaching out is the first step.",
  },
  {
