        ...
        <div>
          ...
          <ul className="space-y-3 text-sm opacity-70">
            <li className="flex items-center gap-2">
              <Phone className="w-4 h-4 shrink-0" /> +1 (555) 123-4567
            </li>
            <li className="flex items-center gap-2">
              <Mail className="w-4 h-4 shrink-0" /> info@worldchangersmhc.org
            </li>
            <li className="flex items-start gap-2">
              <MapPin className="w-4 h-4 shrink-0 mt-0.5" /> 123 Serenity Lane, New York, NY 10001
            </li>
          </ul>
        </div>
      </div>
